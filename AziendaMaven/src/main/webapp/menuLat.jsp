            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="typography.html"><i class="glyphicon glyphicon-align-justify"></i><span> Trova Voce </span></a>
                        </li>
                        ...
                        <li><a href="login.html"><i class="glyphicon glyphicon-lock"></i><span> Logout </span></a>
                        </li>
                    </ul>
